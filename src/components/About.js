      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="relative mb-16 text-center">
          ...
          <h2 className="relative text-4xl lg:text-5xl text-white font-geist tracking-tight font-light">
            About{" "}
            <span className="text-white/80 font-geist tracking-tight font-light">
              Me
            </span>
          </h2>
        </div>
              ...
              <div className="space-y-8">
                <div className="rounded-2xl bg-white/10 border border-white/10 p-6 lg:p-8 text-gray-300 text-base lg:text-lg leading-relaxed hover:bg-white/[0.12] transition-colors duration-300">
                  <p className="font-geist mb-6">
                    ...
                    reliable, and high-performance applications. With several
                    years of experience, I've helped turn complex requirements
                    into clean, maintainable, and user-friendly software for
                    web, mobile, and cloud-based platforms.
                  </p>
                  <p className="font-geist mb-6">
                    My approach combines engineering best practices,
                    problem-solving, and a deep understanding of modern
                    frameworks and tools. From designing RESTful APIs and cloud
                    architectures to implementing responsive frontends, I ensure
                    every system is robust, efficient, and easy to maintain. I
                    thrive collaborating with designers, product managers, and
                    other engineers to align technical solutions with business
                    goals.
                  </p>
                  <p className="font-geist">
                    Beyond coding, I focus on infrastructure and DevOps,
                    leveraging AWS, DigitalOcean, Docker, and CI/CD pipelines to
                    streamline deployments and enhance scalability. For me,
                    great software means solving real problems, delivering
                    measurable impact, and creating seamless experiences that
                ...
                <ul className="space-y-4 text-gray-300">
                  <li className="flex items-start gap-4 group">
                    ...
                    <div className="flex-1 pt-1">
                      <span className="text-sm lg:text-base font-medium font-geist">
                        Committed Worker
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4 group">
                    ...
                    <div className="flex-1 pt-1">
                      <span className="text-sm lg:text-base font-medium font-geist">
                        Open to exciting projects and creative collaborations
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-4 group">
                    ...
                    <div className="flex-1 pt-1">
                      <span className="text-sm lg:text-base font-medium font-geist">
                        Friendly, approachable, and always eager to connect
                      </span>
                    </div>
                  </li>
                </ul>
